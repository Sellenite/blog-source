  ...
  function draggable($ele, isAnywhere = false, adsorb = { x: 20, y: 20 }) {
    ...
    function touchDone(event) {
      ...
      raf(() => {
        ...
        $ele.style.webkitTransition = `left ${MOVE_ANIM_INTER}ms ease-in-out, top ${MOVE_ANIM_INTER}ms liner`;
        $ele.style.transition = `left ${MOVE_ANIM_INTER}ms ease-in-out, top ${MOVE_ANIM_INTER}ms liner`;
